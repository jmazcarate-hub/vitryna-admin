...
function ejecutarSeccion(nombre) {
  const fnMap = {
    ...
    spam:          () => typeof loadSpam          === 'function' && loadSpam(),
    colaboradores: () => typeof loadColaboradores === 'function' && loadColaboradores(),
    captadores:    () => typeof loadCaptadores    === 'function' && loadCaptadores(),
...
const seccionMeta = {
  ...
  spam:          { title: 'Posible Spam',     sub: 'Publicaciones repetidas o muy seguidas en el tiempo' },
  colaboradores: { title: 'Colaboradores',    sub: 'Entidades institucionales del barrio' },
  captadores:    { title: 'Captadores',       sub: 'Campaña de captación de vecinos' },
